...
export const highlightSelectedRecipe = id => {
    ...
    // from funktser massive bolgod ali hediin highlight boltsn bval shineer daragdahad huuchin daragdsanig arilgaj bn
    ...
    const domObj = document
        .querySelector(`.results__link[href*="${id}"]`); // results__link classiin hfref attribue iin utga ni tuhain id bval barij avjin
...
export const renderRecipe = (recipe, isLiked) => {
    // jor objectig argumentara hulej avad ene joriig delgetsend gargaj uzuulne.
    const html = `
